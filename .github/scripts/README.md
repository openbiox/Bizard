...
#### Option 1: GitHub Copilot (Optional - for Review)

GitHub Copilot can be used for reviewing translations (not for generating them).

1. Go to repository Settings → Secrets and variables → Actions
2. Create a secret named `COPILOT_TOKEN`
3. Get your token from your GitHub Copilot subscription

**Note:** The `austenstone/copilot-cli` action is designed for interactive reviews and Q&A, not for automated file translation. It will be used to review translations after they're generated by external AI models.

#### Option 2: OpenAI (Recommended for Translation)

1. Go to repository Settings → Secrets and variables → Actions
2. Create a new secret named `OPENAI_API_KEY`
3. Paste your OpenAI API key from [OpenAI Platform](https://platform.openai.com/)

#### Option 3: Alternative AI Providers (e.g., Xiaomi MiMo, DeepSeek)
...
**Priority:** 
- Translation: `AI_Model_*` variables → `OPENAI_API_KEY`
- Review: `COPILOT_TOKEN` (optional, for translation review)
