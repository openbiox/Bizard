...
This uses the built-in `iris` and `economics` datasets in R, along with a custom dataset and **real-time glucose measurement data** from the `PhysioNet` database. \[1\]。
...
Connect the line segments in the scatter plot
