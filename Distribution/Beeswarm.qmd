...
TCGA_gene_expression <- read.csv("https://raw.githubusercontent.com/DrRobinLuo/Bizard/refs/heads/main/files/TCGA-LIHC.star_fpkm_processed.csv")

# Load the TCGA-LIHC clinical info dataset
TCGA_clinic <- read.csv("https://raw.githubusercontent.com/DrRobinLuo/Bizard/refs/heads/main/files/TCGA.LIHC.clinicalMatrix.csv") %>%
...
<!-- ### 1. Correlation Analysis of Clinical Data -->

<!-- ::: {#fig-BeeswarmApplications1 layout-ncol="2"} -->
...
<!-- Applications of Correlation Analysis of Clinical Data -->
<!-- ::: -->

<!-- Correlation between MM and GS of all miRNAs in each module. -->

<!-- It can be seen that the GS in the turquoise module is highly correlated with MM, illustrating that miRNAs significantly associated with cancer status are often also the important elements of the turquoise module. -->

<!-- ### 2.Displaying Gene Expression Data Across Different Samples -->

<!-- ::: {#fig-BeeswarmApplications2} -->
<!-- ![](../images/Beeswarm_app3.png){fig-alt="BeeswarmApp1" fig-align="center" width="60%"} -->

<!-- Applications of Basic Histogram -->
<!-- ::: -->

<!-- Using bee swarm plots to display the results of single-cell multi-omics data analysis, identifying factors predicting survival in ovarian cancer, breast cancer, and melanoma samples through the jDR method. -->

## Reference

1.Li J, Zhou D, Qiu W, Shi Y, Yang JJ, Chen S, Wang Q, Pan H. Application of Weighted Gene Co-expression Network Analysis for Data from Paired Design. Sci Rep. 2018 Jan 12;8(1):622. doi: 10.1038/s41598-017-18705-z. PMID: 29330528; PMCID: PMC5766625.

2.Cantini L, Zakeri P, Hernandez C, Naldi A, Thieffry D, Remy E, Baudot A. Benchmarking joint multi-omics dimensionality reduction approaches for the study of cancer. Nat Commun. 2021 Jan 5;12(1):124. doi: 10.1038/s41467-020-20430-7. PMID: 33402734; PMCID: PMC7785750.
