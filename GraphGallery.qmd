...
```{r}
#| echo: false
data_OMICS <- data[data$Level1=="HIPLOT" & data$Level2=="BASICS",]
...
```{r}
#| echo: false
data_OMICS <- data[data$Level1=="HIPLOT" & data$Level2=="OMICS",]
...
```{r}
#| echo: false
data_OMICS <- data[data$Level1=="HIPLOT" & data$Level2=="CLINICS",]
...
```{r}
#| echo: false
data_OMICS <- data[data$Level1=="HIPLOT" & data$Level2=="MAP",]
