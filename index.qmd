...
We welcome contributions from the community! Whether it's adding new visualization tutorials, improving existing code, or fixing documentation, your input helps make Bizard better.

Valid contributions will be recorded in our [contribution tracking spreadsheet](https://docs.qq.com/sheet/DSFVkaFVHdFBCSFRw?tab=BB08J2).

For tutorial contributions, please refer to our templates:
- **English template**: [Template/visualization_guidance_EN.qmd](Template/visualization_guidance_EN.qmd)
- **Chinese template**: [Template/visualization_guidance_CH.qmd](Template/visualization_guidance_CH.qmd)

You can also read existing tutorial source files in the repository to understand the structure and style.
