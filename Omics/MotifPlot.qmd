...
motif <- new("pfm", mat = as.matrix(pcm), name = "RNA_motif")
...
pcm1 <- pcm
motif1 <- new("pfm", mat = as.matrix(pcm1), name = "Motif_1")

# Create a second motif (slightly modified for demonstration)
pcm2 <- pcm[, c(2:ncol(pcm), 1)]
motif2 <- new("pfm", mat = as.matrix(pcm2), name = "Motif_2")
